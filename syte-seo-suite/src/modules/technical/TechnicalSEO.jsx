...
import { upsertClient, listAllImplementations, saveTseoTasks, loadTseoTasks, updateTseoTask, logImplementation, updateImplementation } from '../../lib/supabase.js';
...
function TaskCard({ task: t, onUpdate, onMarkDone, onVerify, busy, buildPushItem, onVerified }) {
          ...
          renderExpanded={(c) => {
            ...
            return (
              <div>
                ...
                {topTasks.map(t => (
                  <TaskCard key={t.id} task={t} onUpdate={updateTask} onMarkDone={markDone} onVerify={handleVerify} busy={busy} buildPushItem={buildPushItem} onVerified={refreshTechImpls} />
                ))}
              </div>
            );
          }}
